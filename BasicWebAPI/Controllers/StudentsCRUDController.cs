...
namespace BasicWebAPI.Controllers
{
    ...
    [ApiController]
    public class StudentsCRUDController : ControllerBase
    {
        private readonly StudentContext _context;

        public StudentsCRUDController(StudentContext context)
        {
            _context = context;
        }

        // GET: api/StudentsCRUD
        [HttpGet]
